...
- **System admin** — owns the catalog (job types, scenarios, campaigns) and onboards tenants.
...
- Restoration job types in the seeded catalog (Water Mitigation, Mold Remediation, Structural Cleaning, General Cleaning, Trauma / Biohazard) are referenced by their `type_code` in templates and specs.
