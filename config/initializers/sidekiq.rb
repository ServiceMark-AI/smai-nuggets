...
Sidekiq.configure_server do |config|
  ...
  # Sidekiq server boot. The schedule lives in config/sidekiq_cron.yml and
  # is re-loaded each time Sidekiq starts, so a deploy that changes the
  # file is enough to publish updates.
